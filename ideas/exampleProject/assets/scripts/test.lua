...
function M.init()
    ...
    print("added new")
    print("doing test!")
    box = Box.new(0, 0, 100, 100, color)
    box:changeCamFollow(false)
    print("boom")
    box = Sprite.new("testImg.png", 0, 0, 200, 200)
    local text = Text.new(200, 200, 100, 100, "Hello world!")
    text:changeCamFollow(false)
    print(text ~= nil)
    local tri = Triangle.new(200, 300, 100, 100, color)
    tri:changeCamFollow(false)
    print(tri ~= nil)
    local circle = Circle.new(200, 100, 50, color)
    circle:changeCamFollow(false)
    print(circle ~= nil)
...
function M.update()
    ...
    game.Workspace:setCamera(box:getX(), box:getY()) 
end
